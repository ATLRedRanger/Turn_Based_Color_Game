...
public class AttacksDatabase : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        _blueCrush = new Attack("Blue Crush", "Blue_Crush", 3, 3, 8, 50, 1, Hue.Blue, AttackType.Special, WeaponType.Neutral);
        ...
        //Axe 
        _chop = new Attack("Chop", "Vertical_Slash", 2, 5, 0, 95, 1, Hue.Neutral, AttackType.Physical, WeaponType.Axe);

        //Staff
        _violetBall = new Attack("Violet Ball", "Violet_Ball", 2, 5, 5, 85, 1, Hue.Violet, AttackType.Special, WeaponType.Staff);

        //Sword
        _slash = new Attack("Slash", "Slash", 2, 4, 0, 95, 1, Hue.Neutral, AttackType.Physical, WeaponType.Sword);

        //Hammer
        _slam = new Attack("Slam", "Slam", 2, 4, 0, 95, 1, Hue.Neutral, AttackType.Physical, WeaponType.Hammer);
    ...
    //return a new attack.
    private Attack createAttack(string attackName, string animationName, int attackDamage, int staminaCost, int colorCost, int attackAccuracy, int numOfAttacks, Hue attackColor, AttackType attackType, WeaponType weaponType)
    {
        var attack = new Attack(attackName, animationName, attackDamage, staminaCost, colorCost, attackAccuracy, numOfAttacks, attackColor, attackType, weaponType);
